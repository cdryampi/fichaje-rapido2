    ...
    signature_presets = [
        ...
        },
        {
            ...
            "data": dict(
                ...
                logo_secondary_url="https://dummyimage.com/110x40/9333ea/ffffff.png&text=Nova",
                logo_tertiary_url="https://dummyimage.com/110x40/0f172a/ffffff.png&text=Lex",
        ...
        {
            "name": "Soporte global",
            "description": "Pensada para equipos de atencion 24/7.",
            "data": dict(
                defaults,
                ...
                cta_label="Ver estatus",
                cta_url="https://status.omnilink.io",
                banner_text="Estamos disponibles 24/7 para tus clientes.",
        ...
        },
        {
            ...
            "description": "Suma banner promocional y logos de patrocinadores.",
            "data": dict(
                defaults,
                ...
                cta_url="https://eventia.eu/tickets",
                banner_text="Summit Experience 2025 - 12 al 14 de noviembre",
                ...
                logo_secondary_url="https://dummyimage.com/110x40/ff6b2c/ffffff.png&text=Growfy",
                logo_tertiary_url="https://dummyimage.com/110x40/fcd34d/111111.png&text=Sunrise",
                instagram="https://instagram.com/eventia_live",
            ),
        },
        {
            "name": "Talento remoto",
            "description": "Resalta recursos de cultura y beneficios.",
            "data": dict(
                defaults,
        ...
        {
            "name": "Partners SaaS",
            "description": "Incluye logos conjuntos y CTA para alianzas.",
            "data": dict(
                defaults,
        ...
        },
        {
            ...
            "description": "Ideal para cadenas hoteleras o experiencias VIP.",
            "data": dict(
                defaults,
        ...
        },
        {
            ...
            "description": "Colores sobrios y clausulas mas visibles.",
            "data": dict(
                defaults,
                full_name="Eva Ramos",
        ...
        },
        {
            ...
            "description": "Colores suaves e invitacion a recursos de salud.",
            "data": dict(
                defaults,
                ...
                banner_text="Programa bienestar Q4 - sesiones cada viernes.",
